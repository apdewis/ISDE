...
char **isde_theme_build_resources(void)
{
    ...
    res[i++] = fmt_color("*activeColor", s->active);
    ...
    res[i++] = fmt_color("*Text.background", s->bg_light);
    res[i++] = fmt_color("*Text.foreground", s->fg);
    res[i++] = fmt_color("*Text*textSink.background", s->bg_light);
    ...
    /* Tabs */
    res[i++] = fmt_color("*Tabs.tabBackground", s->bg);
    res[i++] = fmt_color("*Tabs.activeTabColor", s->bg_bright);
    res[i++] = fmt_color("*Tabs.tabBorderColor", s->border);
